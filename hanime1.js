class Hanime1 extends ComicSource {
    ...
    // update url
    url = "https://raw.githubusercontent.com/ccbkv/pica_configs/master/hanime1.js"
      ...
      //  } else if (tags.includes("29963")) {
       ...
       // }
        ...
        for (let tag of tags.split(" ")) {
            if (Hanime1.hanime1Tags[tag] != null) {
                tagsRes.push(Hanime1.hanime1Tags[tag]);
            }
        }
        return new Comic({
            id: id,
    ...
    category = {
        ...
        parts: [
            ...
            },
            {
                ...
                categories: Object.values(Hanime1.hanime1Tags),
    ...
    comic = {
        ...
        loadEp: async (comicId, epId) => {
            if(comicId.startsWith("hanime1")) {
                comicId = comicId.replace("hanime1", "")
            } else if (comicId.startsWith("ha")) {
                comicId = comicId.replace("ha", "")
            }
            let res = await Network.get(`${this.baseUrl}/comic/${comicId}/1/`, {})
            if(res.status !== 200) {
                throw "Invalid Status Code: " + res.status
            }
            let document = new HtmlDocument(res.body)
